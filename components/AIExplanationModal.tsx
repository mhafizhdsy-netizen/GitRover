  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-[60] flex justify-center items-center p-4 animate-fade-in" onClick={onClose}>
      ...
      >
        ...
        <div className="p-6 overflow-y-auto bg-base-50/50 dark:bg-base-950/50">
          <div className="bg-white dark:bg-base-900 p-4 rounded-xl border border-base-200 dark:border-base-800 shadow-sm">
          ...
          <div>
            {loading && (
              <div className="flex flex-col items-center justify-center py-8 space-y-4">
                ...
                <p className="text-sm font-medium text-primary animate-pulse">Thinking deeply about your code...</p>
              </div>
            )}
            ...
            {explanation && (
                <div className="animate-fade-in">
                    <h3 className="text-xs font-bold uppercase tracking-wider mb-3 text-gray-500 dark:text-base-400">Analysis</h3>
