    ...
    <>
      <div className="min-h-screen flex flex-col bg-base-50 dark:bg-base-950">
        ...
        <main className="flex-grow">
          {/* Hero Section */}
          <section className="relative text-center pt-24 sm:pt-32 pb-16 overflow-hidden">
              <div 
                      ...
                      {[
                          ...
                          <div key={i} className="relative flex items-start sm:items-center sm:gap-x-8 mb-12">
                              ...
                              <div className="absolute sm:relative left-0 sm:left-auto flex-shrink-0 z-10">
                                  <div className="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center ring-8 ring-base-50 dark:ring-base-950">
                                      <item.icon size={16} />
                                  </div>
                              </div>
